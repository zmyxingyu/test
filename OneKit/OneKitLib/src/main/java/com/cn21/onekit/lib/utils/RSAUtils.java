...
//	private static String RSANO = "RSA/ECB/NoPadding";
    ...
    public static String encryptWithBase64(String string, Key key)
            throws Exception {
        byte[] binaryData = encrypt(key, string.getBytes());
        String base64String = Base64Utils.encode(binaryData);
        return base64String;
    }
    ...
    public static byte[] decrypt(RSAPrivateKey privateKey, byte[] cipherData)
        ...
        return decrypt((Key) privateKey, cipherData);
    }
